(function() {
  ...
  window.rch_nws[hostkey].Registry = function RchRegistry(client, startConnection) {
    ...
    function addSourceSearch(spiderName, spiderUri) {
      ...
      var source = {
        ...
        onSelect: function(params, close) {
          ...
          if (wtchOpenWithAccess) wtchOpenWithAccess(payload);
          else Lampa.Activity.push(payload);
        }
      }
    ...
    function startPlugin() {
      ...
      function openWtchWithPayload(payload) {
        resetTemplates();
        Lampa.Component.add('wtch_online', component);
        Lampa.Activity.push(payload);
      }
      wtchOpenWithAccess = openWtchWithPayload;
    ...
    Lampa.Storage.listener.follow('change', function (event) {
      if (event.name == 'activity') {
          ...
          if (Lampa.Activity.active().component == 'wtch_online') {
              ...
              Lampa.Controller.toggle('content');
              var addAds = setInterval(function() {
                if (document.querySelector('.online-prestige-watched') !== null) {
                  $('.online-prestige-watched').after(wtchBotAd);
                  clearInterval(addAds);
                }
              }, 50);
          } else {
