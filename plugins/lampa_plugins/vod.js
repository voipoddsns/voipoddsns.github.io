...
window.rch_nws[hostkey].Registry = function RchRegistry(client, startConnection) {
  ...
  function startPlugin() {
    ...
    Lampa.Component.add('vod', component); //то же самое
    resetTemplates();
...
var donate=$('<div class="Message" style="line-height: 0.5;color: #ffffff;font-family: &quot;SegoeUI&quot;, sans-serif;font-size: 1em;box-sizing: border-box;outline: none;user-select: none;display: flex;-webkit-box-align: start;align-items: flex-start;position: relative;background-color: rgba(255, 255, 255, 0.1);border-radius: 0.3em;margin: 1.5em 2em;"><div class="ad-server__text">Спасибо всем, кто уже поддержал и поддерживает ❤️<br>С любой карты через DONATIONALERTS по QR:</br></div><img src="http://arkmv.ru/msx/don.png" class="ad-server__qr"></div>');Lampa.Storage.listener.follow("change",function(e){if("activity"==e.name&&"vod"==Lampa.Activity.active().component)var t=setInterval(function(){null!==document.querySelector(".online-prestige-watched")&&($(".online-prestige-watched").after(donate),clearInterval(t))},50)});
